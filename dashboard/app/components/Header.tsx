...
import { Cpu, Activity, Sun, Moon, Terminal, Shield, Download } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({ isConnected, theme, onToggleTheme, onOpenGetApp }) => {
  return (
    <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 border-b border-[var(--border-subtle)] bg-[var(--bg-card)] gap-4 transition-colors">
      ...
      <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
        ...
        >
          ...
          <span>Get App</span>
          <span className="ml-0.5 px-1 py-0.2 rounded bg-white/20 text-[10px] font-mono">v0.2.1</span>
        </button>
